  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          ...
          <a href="/tambahpelanggan" class="btn btn-success mt-3" style="margin-left: 10%;">Tambah planggan</a>

          <div class="pencarian" style="text-align: center;">
              <form action="/pelanggan/detail" method="get">
